	...
	<div class="article">
		...
		<div class="btns">
		  ...
		  <el-input
			...
			<el-button size='mini' type="success" @click='toAddArticle'>添加</el-button>
			<el-button size='mini' type="success" @click='batchDeleteArticles'>批量删除</el-button>
		</div>
		<!-- 按钮区结束 -->
		<!-- 数据区 -->
		<!-- {{params}} -->
		...
		<el-dialog fullscreen :title="articleDialog.title" :visible.sync="articleDialog.visible">
			{{articleDialog.form}}
		  <el-form :model="articleDialog.form" :rules="rules" >
		  ...
		  <div slot="footer" class="dialog-footer">
		    <el-button size='mini' @click="closeArticleDialog('articleDialog.form')">取 消</el-button>
