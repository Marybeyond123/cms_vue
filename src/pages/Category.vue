<template>
	<div class="category">
		<!-- 按钮区 -->
		<div class="btns">
			<el-button size="small" type="success" @click="toAddCategory">添加</el-button>
			<el-button size="small" type="success" @click="batchDeleteCategory">批量删除</el-button>
		</div>
		<!-- 按钮区结束 -->
		<!-- 表格区 -->
		<div class="table" v-loading="loading">
			<el-table size="small" :data="categories" :border="true" stripe style="width: 100%" @selection-change="handleSelectionChange"> 
		...
		<div class="model">
			...
			{{categoryDialog.form}}
			  <el-form :model="categoryDialog.form" :rules="rules" ref="categoryDialog.form">
			    <el-form-item prop="name" label="栏目名称" label-width="120px">
			  ...
			  <div slot="footer" class="dialog-footer">
			    ...
			    <el-button type="primary" size="small" @click="saveOrUpdateCategory('categoryDialog.form')">确 定</el-button>
			  </div>
			</el-dialog>
		</div>
		<!-- 模态框结束 -->
